...
async def oho(event):
    ...
    await l313l.send_file("me", pic, caption=f"**𓆰تم حفـظ الصـورة الذاتـيـة .. بنجـاح ☑️𓆰**")
    await event.delete()

@l313l.ar_cmd(pattern="(تفعيل الذاتيه|تفعيل الذاتية)")
...
@l313l.ar_cmd(pattern="(تعطيل الذاتيه|تعطيل الذاتية)")
