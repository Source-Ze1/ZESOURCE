...
# <https://www.github.com/Source-Ze/UP_UO/tree/HuRe/LICENSE/>.
import requests
import asyncio
import os
import sys
...
#الملـف كتابـة زلـزال الهيبـه ⤶ @UP_UO خاص بسـورس ⤶ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱
#الملف متعوب عليه So تخمط وماتذكـر المصـدر == اهينـك
#ها خماط رمضان وتخمط hhhhhhh
@l313l.ar_cmd(pattern="أغنية(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
#الملف متعوب عليه So تخمط وماتذكـر المصـدر == اهينـك
#ها خماط رمضان وتخمط hhhhhhh
@l313l.ar_cmd(pattern="رابط(?:\s|$)([\s\S]*)")
async def song2(event):
    song = event.pattern_match.group(1)
    chat = "@apkdl_bot" # code by t.me/UP_UO
