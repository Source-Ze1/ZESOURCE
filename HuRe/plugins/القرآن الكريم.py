...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره البقرة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره آل عمران$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النساء$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المائدة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأنعام$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأعراف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأنفال$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التوبة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره يونس$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره هود$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره يوسف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الرعد$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره إبراهيم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحجر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النحل$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الإسراء$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الكهف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره مريم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره طه$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأنبياء$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحج$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المؤمنون$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النور$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الفرقان$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الشعراء$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النمل$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القصص$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره العنكبوت$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الروم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره لقمان$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره السجدة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأحزاب$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره سبأ$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره فاطر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره يس$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الصافات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره ص$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الزمر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره غافر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره فصلت$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الشورى$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الزخرف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الدخان$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الجاثية$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأحقاف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره محمد$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الفتح$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحجرات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره ق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الذاريات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الطور$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النجم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القمر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الرحمن$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الواقعة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحديد$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المجادلة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحشر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الممتحنة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الصف$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الجمعة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المنافقون$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التغابن$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الطلاق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التحريم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الملك$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القلم$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الحاقة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المعارج$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره نوح$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الجن$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المزمل$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المدثر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القيامة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الإنسان$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المرسلات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النبأ$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النازعات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره عبس$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التكوير$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الإنفطار$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المطففين$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الإنشقاق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره البروج$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الطارق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الأعلى$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الغاشية$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الفجر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره البلد$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الشمس$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الليل$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الضحى$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الشرح$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التين$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره العلق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القدر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره البينة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الزلزلة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره العاديات$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره القارعة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره التكاثر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره العصر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الهمزة$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الفيل$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره قريش$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الماعون$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الكوثر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الكافرون$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره النصر$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره المسد$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الإخلاص$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الفلق$"))
async def jepvois(Voice):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره الناس$"))
async def jepvois(Voice):
