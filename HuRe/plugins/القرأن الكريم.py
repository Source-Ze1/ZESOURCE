...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ محمد صديق المنشاوي$"))
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ مشاري العفاسي$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ عبدالرحمن السديس$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ ناصر القطامي$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ احمد العجمي$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الطبيب احمد نعينع$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ عبدالباسط عبدالصمد$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ ياسر الدوسري$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ ابراهيم الاخضر$"))
async def jepvois(vois):
...
@l313l.on(admin_cmd(outgoing=True, pattern="سوره للقارئ الشيخ محمد جبريل$"))
async def jepvois(vois):
