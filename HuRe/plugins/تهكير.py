...
@l313l.ar_cmd(pattern=r"تهكير$")
async def _(event):
    zel_dev = (5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789, 5650717789)
    if event.reply_to_msg_id:
        ...
        if idd == 5650717789 or idd == 5650717789 or idd == 5650717789 or idd == 5650717789:
