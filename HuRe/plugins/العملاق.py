...
@l313l.on(admin_cmd(pattern="(تجميع العملاق|تجميع عملاق)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await l313l.send_message('@TMWEL10M_BOT', '/start')
        await asyncio.sleep(5)
        msg0 = await l313l.get_messages('@TMWEL10M_BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await l313l.get_messages('@TMWEL10M_BOT', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await l313l.get_messages('@TMWEL10M_BOT', limit=1)
