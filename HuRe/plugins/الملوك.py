...
@l313l.on(admin_cmd(pattern="(تجميع الملوك|تجميع ملوك)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await l313l.send_message('@BotTMOEL10M_bot', '/start')
        await asyncio.sleep(5)
        msg0 = await l313l.get_messages('@BotTMOEL10M_bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await l313l.get_messages('@BotTMOEL10M_bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await l313l.get_messages('@BotTMOEL10M_bot', limit=1)
