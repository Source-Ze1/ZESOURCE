...
@l313l.ar_cmd(pattern="الطقس(?: |$)(.*)")
async def _(event):
    await edit_or_reply(event, "**- ارسـل .طقس + اسـم المدينـة**\n\n**- مثــال :**\n.طقس بغداد")


@l313l.ar_cmd(pattern="طقس (.*)")
async def _(event):
    if event.fwd_from:
        return
...
@l313l.ar_cmd(pattern="وهمي كتابه(?: |$)(.*)")
async def _(event):
...
@l313l.ar_cmd(pattern="وهمي فيديو(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="وهمي لعبه(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="وهمي صوره(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="وهمي موقع(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="وهمي جهات(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="وهمي مرئي(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@l313l.ar_cmd(pattern="ايقاف الوهمي(?: |$)(.*)")
async def _(event):
